<header  id="header-admin" class="w-100">
    ...
    <nav class="navbar sticky-top navbar-default bootsnav bootsnav-admin navbar-fixed-top nav-box-width black-link navbar-expand-lg py-2 shadow">
        <div id="container-header" class="container-fluid nav-header-container">
            <!-- start logo -->
            <div class="container-logo col-lg-3 ps-0">
                <a href="/home" title="IPLANFOR" class="logo">
                    <img src="{{asset('/assets/img/images/logos/iplanfor/Logo_CONJUNTA_Full_Hor_Col_Preto.svg')}}" data-at2x="{{asset('/assets/img/images/logos/iplanfor/Logo_CONJUNTA_Full_Hor_Col_Preto.svg')}}" alt="Logo IPLANFOR" class="logo-light default">
                </a>
            </div>
            <!-- end logo -->
